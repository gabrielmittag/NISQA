...
"""
import yaml
from NISQA_model import speechQualityModel
import argparse
...
parser.add_argument('--deg_dir', type=str, help='folder with speech files')
...
parser.add_argument('--csv_dir', type=str, help='column in csv with files folder')
...
if args['mode'] == 'predict_file':
    ...
    if args['deg_dir'] is None:
        raise ValueError('--deg_dir argument with folder with input files needed')
