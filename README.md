...
## NISQA v0.4
NISQA can be run as a command line tool in Windows 10 for research purposes. Windows 10 needs to be updated to at least ver. 1809. The neural networks "nisqa_cnn.onnx" and "nisqa_lstm.onnx" must be placed in the folder from which you are running "nisqa.exe" from.
